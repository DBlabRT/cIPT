 ...
 */
class ImageToRGBExtendedParser : public Vertica::UDParser {
private:
...
class ImageToRGBExtendedParserFactory : public Vertica::ParserFactory {
public:
    ...
    virtual Vertica::UDParser* prepare(Vertica::ServerInterface &srvInterface,
        ...
        return Vertica::vt_createFuncObject<ImageToRGBExtendedParser>(srvInterface.allocator);
    }
...
RegisterFactory(ImageToRGBExtendedParserFactory);
