...
class RGBToRGBGrey : public TransformFunction
{
                                  ...
                                  PartitionWriter &outputWriter)
    {
        ...
        try {
            ...
            do {
				...
				outputWriter.setInt(3,red);
				outputWriter.setInt(4,green);
				outputWriter.setInt(5,blue);
				outputWriter.setInt(6,static_cast<int>(((red+green+blue)/3)+0.5));
				outputWriter.next();
...
class RGBToRGBGreyFactory : public TransformFunctionFactory
{
                               ...
                               SizedColumnTypes &outputTypes)
    {
		...
		outputTypes.addInt("red");
		outputTypes.addInt("green");
		outputTypes.addInt("blue");
		outputTypes.addInt("grey");
    }

    virtual TransformFunction *createTransformFunction(ServerInterface &srvInterface)
    { return vt_createFuncObject<RGBToRGBGrey>(srvInterface.allocator); }

};

RegisterFactory(RGBToRGBGreyFactory);
